		...
		<ul>
			...
			<?php foreach ( $projects as $project ) : ?>
				...
				<?php
					...
					$project_is_vertical = get_field( 'project_is_vertical', $project->ID );
				...
				<li>
					...
					<a href="#project-<?php echo $project->ID; ?>" class="project">
						...
						<div style="display: none;">
							...
							<div id="project-<?php echo $project->ID; ?>" class="project-details<?php if ( $project_is_vertical ) { ?> vertical<?php } ?>">

								<div class="sample">

									<?php if ( $project_sample_image_large ) { ?>

										<img src="<?php echo $project_sample_image_large[0]; ?>" width="<?php echo $project_sample_image_large[1]; ?>" height="<?php echo $project_sample_image_large[2]; ?>" alt="<?php echo $project->post_title; ?>" />
